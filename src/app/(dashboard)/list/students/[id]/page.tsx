        ...
        <div className='flex-1 p-4 flex flex-col gap-4 xl:flex-row'>
                ...
                <div className="flex flex-col lg:flex-row gap-4">
                        ...
                        <div className="w-2/3 flex flex-col justify-between gap-4 text-right">
                            ...
                            <div className="items-center justify-between gap-2 flex-wrap flex text-xs font-medium">
                                ...
                                <div className="w-full md:w-1/3 lg:w-full flex items-center gap-2">
                                    ...
                                    <span>اردیبهشت ۹۱</span>
                                </div>
                                <div className="w-full md:w-1/3 lg:w-full flex items-center gap-2">
                                    <Image src='/mail.png' width={14} height={14} alt='Email' />
                                    <span>alii.rezaiii@yahoo.com</span>
                                </div>
                                <div className="w-full md:w-1/3 lg:w-full flex items-center gap-2">
                    ...
                    <div className="flex-1 flex gap-4 justify-between flex-wrap">
                        ...
                        <div className="bg-white w-full rounded-md flex gap-4 p-4 md:w-[48%] xl:w-[45%] 2xl:w-[48%]">
                            ...
                            <div>
                                <h1 className='text-xl font-semibold'>هفتم ۲</h1>
                        ...
                        <div className="bg-white w-full rounded-md flex gap-4 p-4 md:w-[48%] xl:w-[45%] 2xl:w-[48%]">
                            ...
                            <div>
                                <h1 className='text-xl font-semibold'>۱۲</h1>
            ...
            <div className="bg-white p-4 rounded-md text-right ">
                ...
                <div className="mt-4 flex gap-4 flex-wrap text-sm text-gray-500 justify-end">
                    <Link className='p-3 rounded-md bg-blueSkyLight' href='/'>دروس دانش اموز</Link>
                    <Link className='p-3 rounded-md bg-specialPurpleLight' href='/'>معلمان دانش اموز</Link>
                    <Link className='p-3 rounded-md bg-specialYellowLight' href='/'>نتایج دانش اموز</Link>
                    <Link className='p-3 rounded-md bg-pink-50' href='/'>امتحانات دانش اموز</Link>
                    <Link className='p-3 rounded-md bg-blueSkyLight' href='/'>تکالیف دانش اموز</Link>
                </div>
            </div>
            <Performance />
            <Announcements />
